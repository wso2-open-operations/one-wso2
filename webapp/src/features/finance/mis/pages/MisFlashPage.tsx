...
//
// ---- what ticket 15 builds, and what the three after it add ----------------
//
// Read-only. This is the only MIS surface where users WRITE, and all of that is
// still ahead: budget and forecast cell edits (ticket 16), comments against the
// admin backend (ticket 17, blocked on ticket 04 establishing whether that
// backend is alive at all), and the ExcelJS export (ticket 18). Each extends
// this screen and the detail dialog behind it rather than replacing them.
//
